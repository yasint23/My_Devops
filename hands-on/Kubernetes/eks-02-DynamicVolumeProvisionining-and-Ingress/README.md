...
```bash
kubectl apply -f yasin-pvc.yaml
```
...
kubectl get pv,pvc
```
- You will see an output like this -After creating pod below you can see output-

```text
NAME                                       CAPACITY   ACCESS MODES   RECLAIM POLICY   STATUS   CLAIM                     STORAGECLASS   REASON   AGE
pvc-1cd62230-2c0f-4678-b743-837291dcd61c   3Gi        RWO            Delete           Bound    default/yasin-pv-claim   aws-standard            12s

NAME              STATUS   VOLUME                                     CAPACITY   ACCESS MODES   STORAGECLASS   AGE
yasin-pv-claim   Bound    pvc-1cd62230-2c0f-4678-b743-837291dcd61c   3Gi        RWO            aws-standard   2m19s
```
...
yasin-pv-claim   Bound    pvc-a432a88e-9869-4c69-bded-7b8518051666   3Gi        in-pvc.yaml
RWO            aws-standard   8m6s
